...
if (Config.WORKTYPE == 'private') {
    ...
    DrkBox.addCommand({pattern: 'faceai', fromMe: true, desc: Lang.fc}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `${MLang.by}`})
    ...
    DrkBox.addCommand({pattern: 'animai', fromMe: true, desc: Lang.ani}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: `${MLang.by}`})
        await new Promise(r => setTimeout(r, 500));
