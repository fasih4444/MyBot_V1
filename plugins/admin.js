...
DrkBot.addCommand({pattern: 'ban ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
DrkBot.addCommand({pattern: 'add(?: |$)(.*)', fromMe: false, onlyGroup: true, desc: Lang.ADD_DESC}, (async (message, match) => {  
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
DrkBot.addCommand({pattern: 'promote ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
DrkBot.addCommand({pattern: 'demote ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.DEMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
...
DrkBot.addCommand({pattern: 'mute ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.MUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
DrkBot.addCommand({pattern: 'unmute ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.UNMUTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
DrkBot.addCommand({pattern: 'invite ?(.*)', fromMe: false, onlyGroup: true, desc: Lang.INVITE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    var userad = await checkAdmin(message);
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
...
DrkBox.addCommand({pattern: 'vip', fromMe: false, onlyGroup: true}, (async (message, match) => {
    ...
    if (!userad) return await message.client.sendMessage(message.jid,Lang.USER_NOT_ADMIN,MessageType.text);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
    await message.sendMessage('┏━━━━━━━━━━━━━━━━━━━\n┃〘 *MENU VIP* 〙\n┗━━━━━━━━━━━━━━━━━━━\n*🛑 Comando:*\n/add\n*💬 Descripción:*\nAgrega personas al grupo.\n❓ Ejemplo: /add 57301xxxxxxx\n\n*🛑 Comando:*\n/ban \n*💬 Descripción:*\nElimina a una persona del grupo. (Responda o etiquete a la persona junto al comando).\n\n*🛑 Comando:*\n/promote \n*💬 Descripción:*\nAsciende a cualquier persona a administrador.\n\n*🛑 Comando:*\n/demote \n*💬 Descripción:*\nQuita el puesto de Administrador\n\n*🛑 Comando:*\n/mute \n*💬 Descripción:*\nChat del grupo cerrado. Ahora sólo los administradores pueden publicar mensajes.\n\n*🛑 Comando:*\n/unmute \n*💬 Descripción:*\nAbre el chat del grupo. Ahora cualquiera puede enviar un mensaje.\n\n*🛑 Comando:*\n/invite\n*💬 Descripción:*\nMuestra el enlace de invitación del grupo.\n\n*🛑 Comando:*\n/welcome\n*💬 Descripción:*\nEstablece un mensaje de bienvenida. Si no escribe un mensaje, aparecerá el mensaje de bienvenida por defecto.\n\n*🛑 Comando:*\n/goodbye\n*💬 Descripción:*\nEstablece un mensaje de despedida. Si no escribe un mensaje, aparecerá el mensaje de bienvenida por defecto.\n\n*🛑 Comando:*\n/block \n*💬 Descripción:*\nBloquea a una persona.\n\n*🛑 Comando:*\n/unblock \n*💬 Descripción:*\nDesbloquea a una persona.\n\n*🛑 Comando:*\n/tagall\n*💬 Descripción:*\nMenciona a todos los usuarios del grupo.\n\n*🛑 Comando:*\n/tagadmin\n*💬 Descripción:*\nMenciona a todos los admin del grupo.\n┏━━━━━━━━━━━━━━━━━━━\n  *𝐃𝐫𝐤𝐁𝐨𝐭* el mejor 😉\n┗━━━━━━━━━━━━━━━━━━━\n');
}));
